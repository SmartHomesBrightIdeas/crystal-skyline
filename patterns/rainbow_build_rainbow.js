...
var divisions = 1;    // number of segments
...
export function beforeRender(delta) {
  ...
  t1 = time(.01);    // color animation timer.
...
export function render(index) {
  ...
  index = abs(index); // where is the current pixel in the current segment?
...
export var speed, size, segments, colorMode, center, counter, frameTime, msPerFrame, pos, index;
